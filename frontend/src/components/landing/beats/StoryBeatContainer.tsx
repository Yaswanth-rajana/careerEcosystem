...
export const StoryBeatContainer: React.FC<StoryBeatContainerProps> = ({
  ...
  return (
    <section
      id={id}
      className={cn(
        'relative py-20 lg:py-28 border-b border-slate-200/60 transition-colors',
        className
      )}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="w-full">
            {children || (
              <Card variant="neutral" className="p-8 sm:p-12 border-dashed border-2 border-slate-200 bg-slate-50/50">
                <div className="flex flex-col items-center justify-center text-center space-y-3 py-6">
                  <div className="px-3 py-1 rounded-md bg-slate-200 font-mono text-xs text-slate-600">
