...
export const MentorSkeletonCard: React.FC = () => {
  return (
    <div className="rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white/70 dark:bg-[#111827]/70 p-5 space-y-4 animate-pulse">
      ...
      <div className="flex flex-wrap gap-1.5 pt-1">
        <div className="w-16 h-6 rounded-md bg-slate-200 dark:bg-slate-800" />
        <div className="w-20 h-6 rounded-md bg-slate-200 dark:bg-slate-800" />
        <div className="w-14 h-6 rounded-md bg-slate-200 dark:bg-slate-800" />
      </div>
